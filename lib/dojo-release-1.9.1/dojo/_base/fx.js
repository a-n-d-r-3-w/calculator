...
_c.prototype.getText=function(n){
...
_19._active=true;
_19._paused=false;
var _1a=_19.curve.getText(_19._getStep());
if(!_19._percent){
...
_1b._paused=true;
_1b._fire("onPause",[_1b.curve.getText(_1b._getStep())]);
return _1b;
...
_20._fire("onStop",[_20.curve.getText(_20._getStep())]);
...
_21._fire("onAnimate",[_21.curve.getText(_23)]);
if(_21._percent<1){
_21._startTimer();
}else{
_21._active=false;
...
_2e.prototype.getText=function(r){
var ret={};
