...
return declare("dojo.data.api.Notification", Read, {
	...
	onSet: function(/* dojo/data/api/Item */ item,
		...
		// summary:
		//		This function is called any time an item is modified via setText, setValues, unsetAttribute, etc.
		// description:
		//		This function is called any time an item is modified via setText, setValues, unsetAttribute, etc.
		...
		// oldValue:
		//		The old value of the attribute.  In the case of single value calls, such as setText, unsetAttribute, etc,
		...
		// newValue:
		//		The new value of the attribute.  In the case of single value calls, such as setText, this value will be
	...
	onNew: function(/* dojo/data/api/Item */ newItem, /*object?*/ parentInfo){
		...
		// |		newValue: something	//The new value of the attribute.  In the case of single value calls, such as setText, this value will be
		// |					//generally be an atomic value of some sort (string, int, etc, object).  In the case of multi-valued attributes,
		// |					//it will be an array.
		// |	}
		// returns:
