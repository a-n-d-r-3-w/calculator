...
return declare("dojo.data.api.Read", null, {
	...
	getText: function(	/* dojo/data/api/Item */ item,
		...
		//		store.getText(item, attribute) will return undefined.
		// item:
		//		The item to access values on.
		// attribute:
		//		The attribute to access represented as a string.
		// defaultValue:
		//		Optional.  A default value to use for the getText return in the attribute does not exist or has no value.
		// returns:
		...
		// example:
		//	|	var darthVader = store.getText(lukeSkywalker, "father");
		throw new Error('Unimplemented API: dojo.data.api.Read.getText');
	},

	getValues: function(/* dojo/data/api/Item */ item,
						/* attribute-name-string */ attribute){
		// summary:
		//		This getValues() method works just like the getText() method, but getValues()
