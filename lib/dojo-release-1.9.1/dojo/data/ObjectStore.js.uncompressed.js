...
return declare("dojo.data.ObjectStore", [Evented],{
		...
		getText: function(/*Object*/ item, /*String*/property, /*value?*/defaultValue){
			// summary:
		...
		getValues: function(item, property){
			...
			var val = this.getText(item,property);
		...
		getLabel: function(/* dojo/data/api/Item */ item){
			...
			if(this.isItem(item)){
				return this.getText(item,this.labelProperty); //String
			}
		...
		newItem: function(data, parentInfo){
			...
			if(parentInfo){
				...
				var values = this.getText(parentInfo.parent,parentInfo.attribute,[]);
				// set the new value
				values = values.concat([data]);
				data.__parent = values;
				this.setText(parentInfo.parent, parentInfo.attribute, values);
			}
		...
		deleteItem: function(item){
			...
			// setText is the way to go.
			this.changing(item, true);

			this.onDelete(item);
		},
		setText: function(item, attribute, value){
			// summary:
			//		sets 'attribute' on 'item' to 'value'
			//		See dojo/data/api/Write.setText()
		...
		setValues: function(item, attribute, values){
			...
			this.setText(item,attribute,values);
		},
